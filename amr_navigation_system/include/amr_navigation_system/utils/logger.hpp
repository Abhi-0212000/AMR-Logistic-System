...
public:
    ...
    NodeLogger(const std::string& base_path, const std::string& package_name, 
    ...
    void log(int level, const std::string& message, const std::string& file_name, 
    ...
    void log_info(const std::string& message, const std::string& file_name, 
                  uint32_t line_number, const std::string& function_name);
    void log_warn(const std::string& message, const std::string& file_name, 
                  uint32_t line_number, const std::string& function_name);
    void log_error(const std::string& message, const std::string& file_name, 
                   uint32_t line_number, const std::string& function_name);
    void log_fatal(const std::string& message, const std::string& file_name, 
                   uint32_t line_number, const std::string& function_name);
